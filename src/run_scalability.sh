...
qryX="/data/bhuan102/mvzd-data-processing/range_count_query/uniform/100M-small-100M/1.in-0.qry"
...
# exp on physical cores
# for i in $(seq 1 31); do
#     echo "Running with Threads: $i"
#     export PARLAY_NUM_THREADS=$i
#     # numactl --physcpubind=0-$i --localalloc ./main -i $file -a combined -t range-report -r $qry0 
#     numactl --physcpubind=0-$i --localalloc ./main -i $file -a combined -t range-report -r $qryX
# done
