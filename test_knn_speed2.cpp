...
int main() {
    ...
    BoostPoint bg_q(325000.0, 325000.0); // Point exactly in the middle of dense data!
    ...
    cout << "Tree size parameter took " << chrono::duration_cast<chrono::milliseconds>(t2-t1).count() << " ms" << endl;
    ...
    cout << "K parameter took " << chrono::duration_cast<chrono::milliseconds>(t4-t3).count() << " ms" << endl;
    return 0;
}
